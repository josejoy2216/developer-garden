...
exports.WILDLIFE = exports.ACHIEVEMENTS = void 0;
exports.currentStreak = currentStreak;
exports.evaluateUnlocks = evaluateUnlocks;
...
function currentStreak(state) {
    ...
    if (!days.has((0, types_1.dayKey)(cursor))) {
        cursor.setDate(cursor.getDate() - 1);
    }
    while (days.has((0, types_1.dayKey)(cursor))) {
        streak++;
        cursor.setDate(cursor.getDate() - 1);
    }
    return streak;
...
function evaluateUnlocks(state, anyMature) {
    const unlocked = [];
    const now = Date.now();
    ...
    for (const w of exports.WILDLIFE) {
